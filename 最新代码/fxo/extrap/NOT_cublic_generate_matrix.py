...
class FXOptionCubicDeltaExtrapolator:
    def __init__(self, deltas, rr_values, bf_values):
        ...
        self.cubic_interp = CubicSpline(self.deltas_values, self.vol_values, bc_type='not-a-knot', extrapolate=True)
...
def build_market_matrix(atm: float,rr_values:np.array, bf_values:np.array, tenor:str, delta_df: DataFrame, index:int):
    ...
    extrapolator = FXOptionCubicDeltaExtrapolator(deltas, rr_values, bf_values)
