...
def fx_option_price(S0, K, T, r_d, r_f, sigma, option_type, N=100, M=100):
    """
...
'''
S0 = 7.00  # Spot exchange rate (USD/CNY)
K = 7.00  # Strike price
T = 1.0  # Time to maturity (1 year)
r_d = 0.03  # Domestic risk-free rate (CNY rate, 3%)
r_f = 0.01  # Foreign risk-free rate (USD rate, 1%)
sigma = 0.15  # Volatility of the exchange rate (15%)
'''
#1Y
...
call_price = fx_option_price(S0, K, T, r_d, r_f, sigma, option_type='call')
put_price = fx_option_price(S0, K, T, r_d, r_f, sigma, option_type='put')
