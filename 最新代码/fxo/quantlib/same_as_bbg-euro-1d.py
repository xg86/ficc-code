...
Strike = 7.12
Sigma = 1.5/100 #Vol
Ccy1Rate =  4.4023/100 #eur DEPO
Ccy2Rate = 1.4698/100 #usd DEPO
OptionType = ql.Option.Call

#Option dates in quantlib objects
EvaluationDate = ql.Date(31, 10,2024)
SettlementDate = ql.Date(5, 11, 2024) #Evaluation +2
ExpiryDate = ql.Date(1, 11, 2024) #Evaluation + term which is 1 week
DeliveryDate = ql.Date(5, 11, 2024) #Expiry +2
...
BsPrice = Option.NPV()
print("NPV  is:", Option.NPV()*1_000_000)
print("Delta is:", Option.delta()*1_000_000)
