...
Strike = 6.8334
Sigma = 6.137/100 #Vol
Ccy1Rate =  4.523/100 #eur DEPO
Ccy2Rate = 2.1225/100 #usd DEPO
OptionType = ql.Option.Call

#Option dates in quantlib objects
EvaluationDate = ql.Date(31, 10,2024)
SettlementDate = ql.Date(4, 11, 2027) #Evaluation +2
ExpiryDate = ql.Date(2, 11, 2027) #Evaluation + term which is 1 week
DeliveryDate = ql.Date(4, 11, 2027) #Expiry +2
...
BsPrice = Option.NPV()
print("NPV  is:", Option.NPV()*1000000)
print("Delta is:", Option.delta()*1000000)
print("Delta is:", Option.deltaForward()*1000000)
